import { IntroSection2, CenterSection } from "@/styles/intro/introduce-style";
        ...
        <IntroSection2>
            <CenterSection>
                ...
                <article>
                    ...
                    <p className="description">
                        전체 공개 글로 게시물을 작성하면 다른 사람들도 글을 볼 수 있어요.
                        <br />
                        마음이맞는 사람과 대화 하면서 속마음을 털어놔 보세요!
                    </p>
                </article>
                <article>
                    <p className="title">
                    ...
                    <p className="description">
                        ...
                        ! <br />
                        나만 보기로 글을 작성하면 다른 사람들과 공유되지 않아요.
                    </p>
                </article>
            </CenterSection>
        </IntroSection2>
