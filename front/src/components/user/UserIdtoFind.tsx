...
import {Form, FormTitle, FormButton, Container, FindMessage, Input, AuthButton, CorrectButton, ModalLabel, ConfirmAccount, InputError } from "@/styles/common/Modal/Form-style";
